common =
    ...
    .done = Готово
    .delete = Удалить
    .info = Какой то текст для того что бы отображать клавиатуру 🙃
start =
...
profile =
    ...
    .menu_settings_name_confirm = Пожалуйста, введите свое имя
    ...
    .menu_settings_description_min_failure = Описание слишком маленькое. Пожалуйста, отредактируйте описание так, чтобы количество символов было больше 2
    .menu_settings_description_max_failure = Описание слишком большое. Пожалуйста, отредактируйте описание так, чтобы количество символов не превышало 200
    ...
    .photo_add_failure = Ошибка добавления фото, повторите попытку или завершите настройку
    ...
    .keyboard_show_all_photo = Показать все фото
...
search =
    ...
    .empty_all = Пожалуйста заполните свой <b>Профиль</b>: /profile
                 И <b>Фильтры</b>: /filters
