...
profile =
    ...
    .menu_settings_description_confirm = Пожалуйста добавте описание
    .menu_settings_description_success = Описание успешно добавлено
    .menu_settings_description_failure = Описание слишком большое. Пожалуйста повторите попытку
    .menu_settings_photo_info =
        { NUMBER($images, type: "ordinal") ->
            [0] У вас нету фотографий. Отправте фото, что бы можно было пользоваться ботом
    ...
    .print_profile = <b>Ваш профиль 📋</b>
                     ...
                     📌 Для того, что бы пользоваться ботом, убедитесь в том, что вы указали <b>все</b> данные. И добавили хотя бы <b>1</b> фото
