...
profile =
    .menu_settings = Изменить профиль ⚙️
    ...
    .menu_settings_photo = Добавить фото
    .menu_settings_photo_confirm = Пожалуйста добавте не больше 3 фотографий
    ...
    .photo_failure = Ошибка добавления фото, повторите попытку
